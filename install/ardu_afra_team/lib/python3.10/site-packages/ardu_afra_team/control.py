...
🕹️ A: Yaw Left
🕹️ D: Yaw Right
⬆️ Up Arrow: Pitch Forward
⬇️ Down Arrow: Pitch Backward
⬅️ Left Arrow: Roll Left
➡️ Right Arrow: Roll Right
...
def main():
    ...
    try:
        ...
        while True:
            ...
            print("+-------+---------+---------+---------+")
            print(f"|   1   |  {twist.linear.x:.2f}   |  {twist.linear.y:.2f}   |  {twist.linear.z:.2f}   |")
            print(f"|   2   |  {twist.linear.x + 2:.2f}   |  {twist.linear.y + 2:.2f}   |  {twist.linear.z:.2f}   |")
            print(f"|   3   |  {twist.linear.x + 4:.2f}   |  {twist.linear.y + 2:.2f}   |  {twist.linear.z:.2f}   |")
            print(f"|   4   |  {twist.linear.x + 6:.2f}   |  {twist.linear.y + 2:.2f}   |  {twist.linear.z:.2f}   |")
            print("+-------+---------+---------+---------+")
            print(f"🚁 Current Velocity: X: {twist.linear.x:.2f} Y: {twist.linear.y:.2f} Z: {twist.linear.z:.2f} Yaw: {twist.angular.z:.2f}")
